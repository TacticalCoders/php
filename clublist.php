<?php
	...
	$sql ="select clubName,onelineIntro,intro,division,category,location,contact,website,recruitStart,recruitEnd
	...
	echo "<table border=1>";
	echo "<tr>";
	echo "<th>동아리 이름</th> <th>한 줄 소개</th> <th>동아리 소개</th> <th>구분</th> <th>카테고리</th>";
	...
	while($row = mysqli_fetch_array($ret)){
		...
		echo "<td>","<a href='update.php?clubId=",$row['clubId'], "'>수정</a></td>";
		echo "<td>","<a href='delete.php?clubId=",$row['clubId'], "'>삭제</a></td>";	
		echo "</tr>";
	}
